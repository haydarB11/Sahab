                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Edit vendor</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_vendor_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_edit_vendor_form" method="POST" class="form"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" min="0" name="commission"
                                            class="form-control form-control-lg form-control-solid" placeholder="commission" value="{{ $vendor->commission }}"/>
                                    </div>
                                    <!--end::Col-->
                                </div>
