        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid" style="padding: 50px; margin: 10px">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <!--begin::Card header-->
                    <!--begin::Content-->
                    <div id="kt_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_edit_profile_form" method="POST" class="form" action="{{ route('profile.update') }}"
                            data-kt-redirect="{{ route('profile') }}">
                            @csrf
                            <!--begin::Card body-->
