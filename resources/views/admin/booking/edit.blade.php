...
@section('content')
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Edit Faq</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_edit_faqs_form" method="POST" class="form"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="answer_en"
                                            class="form-control form-control-lg form-control-solid" placeholder="Answer"
                                            value="{{ $faq->answer_en }}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="d-flex flex-stack w-lg-50">
                                    ...
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input id="toggleCheckbox1" class="form-check-input" type="checkbox" value="1"
                                            name="status"  @if ($faq->status == 1) checked @endif />
    ...
    <script>
        document.getElementById("kt_edit_faqs_form").addEventListener("submit", function(event) {
