            ...
            <div id="kt_app_content" class="app-content flex-column-fluid" style="padding: 50px; margin: 10px">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_category_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_add_category_form" method="POST" class="form"
                            action="{{ route('categories.store') }}" data-kt-redirect="{{ route('categories.index',['type' => request()->input('type') ]) }}">
                            @csrf
                            <!--begin::Card body-->
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                {{-- <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <select name="type" aria-label="Select a Type" data-control="select2"
                                        data-placeholder="Select a Type..." data-dropdown-parent="#kt_add_category_form"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="title_ar"
                                            class="form-control form-control-lg form-control-solid" placeholder="العنوان"
                                            dir="rtl" />
                                    </div>
                                    <!--end::Col-->
                                </div>
