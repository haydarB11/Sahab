...
@section('content')
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid" style="padding: 50px; margin: 10px">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <!--begin::Card header-->
                    <!--begin::Content-->
                    <div id="kt_customer_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_edit_customer_form" method="POST" class="form"
                            action="{{ route('customers.update', $customer->id) }}"
                            data-kt-redirect="{{ route('customers.index') }}">
                            @csrf
                            <!--begin::Card body-->
    ...
    {{-- <script>
        document.getElementById("kt_edit_customer_form").addEventListener("submit", function(event) {
                        ...
                        if (response.errors) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    '{{ route('customer.index') }}'; // Change '/new-page' to the URL you want to redirect to
                            }, 2000);
