<div style="@import url('https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&display=swap'); font-family: 'Cairo', sans-serif;background-color: #eeeeef; padding: 50px 0; ">
    <div style="max-width:640px; margin:0 auto; ">
        ...
        <div style="padding: 20px; background-color: rgb(255, 255, 255);">
            <p style="">
                <span style="color: rgb(85, 85, 85); font-size: 14px;">{{__('New booking has been successfully confirmed')}}.</span>
                {{-- <span style="color: rgb(85, 85, 85); font-size: 14px;">{{__('Thank you for choosing our service')}}.</span><br> --}}
            </p>
            <p style=""><br></p>
            <p style="">
                <span style="color: rgb(85, 85, 85); font-size: 14px;">{{__('Booking Details')}}:</span><br>
                ...
                <span style="color: rgb(85, 85, 85); font-size: 14px;">{{__('User Name')}}: {{$name}}</span><br>
